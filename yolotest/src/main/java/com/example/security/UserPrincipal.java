 ...
 * to perform authentication and authorization.身份驗證、授權
 * 這個接口中規定了用户的幾個必須要有的方法，所以我們創建一個UserPrincipal類来實現這個接口。
 * 不直接使用User類是因為UserDetails完全是為了安全服務
 * 它和我們的領域類可能有部分属性重叠，但很多的接口其實是安全定制的，所以最好新建一個類
*/
